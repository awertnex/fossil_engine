...
{
    CHUNK_SCHEDULER_BUDGET_PRIORITY_LOW = 100000,
    CHUNK_SCHEDULER_BUDGET_PRIORITY_MID = 150000,
    CHUNK_SCHEDULER_BUDGET_PRIORITY_HIGH = 200000
...
{
    CHUNK_WORK_COST_SCAN = 1,
    CHUNK_WORK_COST_PUSH = 8,
    CHUNK_WORK_COST_POP = 8,
    CHUNK_WORK_COST_IMPORT = 64,
    CHUNK_WORK_COST_EXPORT = 64,
    CHUNK_WORK_COST_MESHING = 256,
    CHUNK_WORK_COST_BLOCK_GENERATION = 4
} chunk_work_cost;
